 ...
 */
final class Version20220630114741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client DROP nom, DROP adresse');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client ADD nom VARCHAR(255) NOT NULL, ADD adresse VARCHAR(255) NOT NULL');
